            ...
            <div id="footer-content" class="text-center">
                <div class="flex">
                    <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                        ...
                        BlockFinder: Discover Blockchain Innovations
                    </a>
                </div>
            </div>
            <div class="flex">
                <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                    © 2023 BlockFinder. Empowering users to explore and uncover the latest in blockchain technology. Stay ahead of the curve with real-time updates and cutting-edge information.
                </div>
            </div>
        </div>
    </footer>
